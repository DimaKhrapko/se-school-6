...
async function sendReleaseEmail(emails, repo, latestTag) {
  ...
  const mailOptions = {
    ...
    bcc: emails,
    subject: `New release ${repo}: ${latestTag}`,
    html: `
        <h2>Hello!</h2>
        <p>The repository <b>${repo}</b> has just been updated to version <b>${latestTag}</b>.</p>
